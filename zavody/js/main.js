$(function() {
 ...
 $('.company-head-mobile-menu li').on('click', function() {
    $('.company-head-mobile-menu').toggleClass('show-dropdown-menu');
  });
 $('.company-head-mobile-menu .scrollto').on('click', function() {
    $('.company-head-mobile-menu').removeClass('show-dropdown-menu');
  });
  // user-dropdown
